...
```mermaid
flowchart LR
  subgraph PRE[Pre (VLR)]
    P0[58 (root)]
    subgraph PLEFT[Left Pre]
      P1[24] --> P2[0] --> P3[5] --> P4[34] --> P5[41]
    end
    subgraph PRIGHT[Right Pre]
      P6[67] --> P7[62] --> P8[64] --> P9[69] --> P10[78]
    end
  end

  subgraph IN[In (LVR)]
    subgraph ILEFT[Left In]
      I0[0] --> I1[5] --> I2[24] --> I3[34] --> I4[41]
    end
    I5[58 (root)]
    subgraph IRIGHT[Right In]
      I6[62] --> I7[64] --> I8[67] --> I9[69] --> I10[78]
    end
  end
